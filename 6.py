...
if author == "":
  ...
  print(Colorate.Diagonal(Colors.red_to_white, "Nhập [1] Để Vào Tool Pinterest "))
...
os.system('cls' if os.name== 'nt' else 'clear')
banner()
print("\033[1;32mDanh Sách Acc Pinterest Hiện Có ")
print("\033[97m==================================")
headers = {
...
def dsacc():
  ...
  for i in range(len(chontktiktok["data"])):
    print(Colorate.Diagonal(Colors.green_to_red,f"[{i+1}] {chontktiktok["data"][i]["pinterest_username"]} | 🍉 Online"))
dsacc() 
print("\033[97m==================================")
while True:
  try:
...
# Kiểm tra loại nhiệm vụ
    ...
    if nhantien and nhantien.get("status") == 200:
        ...
        try:
            ...
            print("\033[1;35mBỏ qua job lỗi thành công ", end="\r")
            sleep(1.5)
            checkdoiacc += 1
        except:
            pass
