...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36mTHTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33mX   \033[1;39m ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTHTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTHTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTHTOOL\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}LIKE{do} | {trang}ẨN ID{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))} ')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}ẨN ID{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))} ')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}ẨN ID{do} | {vang}+600{do} | {luc}{str(format(int(xu),","))} ')
                                    loicxcmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
