...
print(                    f" \033[1;37m=> \033[1;32mNhập \033[1;39m[\033[1;33m26\033[1;39m]\033[1;32m Tool Buff View Tiktok")  
print(f"\033[1;37m---------------------------------------------------  ")
...
if chon == "26":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/view.py').text
              exec(code, globals())
            except:
              sys.exit()                                             