...
print (Colorate.Diagonal(Colors.blue_to_white, "┌──────────────────────┐"))
print (Colorate.Diagonal(Colors.blue_to_white, "║  Tool Trao Đổi Sub   ║"))
print (Colorate.Diagonal(Colors.blue_to_white, "└──────────────────────┘"))
print(                    f" \033[1;37m=> \033[1;32mNhập \033[1;39m[\033[1;33m9\033[1;39m]\033[1;32m Tool Tds Tiktok") 
print(                    f" \033[1;37m=> \033[1;32mNhập \033[1;39m[\033[1;33m10\033[1;39m]\033[1;32m Tool Tds Instagram") 
print(                    f" \033[1;37m=> \033[1;32mNhập \033[1;39m[\033[1;33m11\033[1;39m]\033[1;32m Tool Tds Facebook") 
print(f"\033[1;37m---------------------------------------------------  ")
...
if chon == "3":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/1.3_linkedin.py').text
              exec(code, globals())
            except:
              sys.exit()          
if chon == "4":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/SnapChat.py').text
              exec(code, globals())
            except:
              sys.exit()          
if chon == "5":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/1.8_twiiter.py').text
              exec(code, globals())
            except:
              sys.exit()       
if chon == "6":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/1.4_Pinterest.py').text
              exec(code, globals())
            except:
              sys.exit()              
if chon == "7":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/1.5_shopee.py').text
              exec(code, globals())
            except:
              sys.exit()  
if chon == "8":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/threads.py').text
              exec(code, globals())
            except:
              sys.exit()  
if chon == "9":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/tdstiktok.py').text
              exec(code, globals())
            except:
              sys.exit()  
if chon == "10":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/2.3_tdsig.py').text
              exec(code, globals())
            except:
              sys.exit()       
if chon == "11":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/2.2_tdsfb.py').text
              exec(code, globals())
            except:
              sys.exit()              
if chon == "12":
            try:               
              kiem_tra_mang()
              code = requests.get('https://raw.githubusercontent.com/vuongvanhoang/Toolvip/refs/heads/main/obf-nuoitt.py').text
              exec(code, globals())
            except:
              sys.exit()                     